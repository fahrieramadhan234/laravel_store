...
<body class="ecommerce">
    ...
    <div class="header">
        <div class="container">
            <a class="site-logo" href="shop-index.html"><img
                    src="{{asset('frontend/assets/corporate/img/logos/logo-shop-red.png')}}" alt="Metronic Shop UI"></a>
                ...
                <div class="top-cart-content-wrapper">
                    <div class="top-cart-content">
                        <ul class="scroller" style="height: 250px;">
                            <li>
                                <a href="shop-item.html"><img src="{{asset('frontend/assets/pages/img/cart-img.jpg')}}"
                                        ...
                                        <div class="col-md-12 nav-brands">
                                            <ul>
                                                <li><a href="shop-product-list.html"><img title="esprit" alt="esprit"
                                                            src="{{asset('frontend/assets/pages/img/brands/esprit.jpg')}}"></a>
                                                </li>
                                                <li><a href="shop-product-list.html"><img title="gap" alt="gap"
                                                            src="{{asset('frontend/assets/pages/img/brands/gap.jpg')}}"></a>
                                                </li>
                                                <li><a href="shop-product-list.html"><img title="next" alt="next"
                                                            src="{{asset('frontend/assets/pages/img/brands/next.jpg')}}"></a>
                                                </li>
                                                <li><a href="shop-product-list.html"><img title="puma" alt="puma"
                                                            src="{{asset('frontend/assets/pages/img/brands/puma.jpg')}}"></a>
                                                </li>
                                                <li><a href="shop-product-list.html"><img title="zara" alt="zara"
                                                            src="{{asset('frontend/assets/pages/img/brands/zara.jpg')}}"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="product-item">
                                                <div class="pi-img-wrapper">
                                                    <a href="shop-item.html"><img
                                                            src="{{asset('frontend/assets/pages/img/products/model4.jpg')}}"
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-6">
                                            <div class="product-item">
                                                <div class="pi-img-wrapper">
                                                    <a href="shop-item.html"><img
                                                            src="{{asset('frontend/assets/pages/img/products/model3.jpg')}}"
                                                            class="img-responsive" alt="Berry Lace Dress"></a>
                                                </div>
                                                <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                                                <div class="pi-price">$29.00</div>
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-6">
                                            <div class="product-item">
                                                <div class="pi-img-wrapper">
                                                    <a href="shop-item.html"><img
                                                            src="{{asset('frontend/assets/pages/img/products/model7.jpg')}}"
                                                            class="img-responsive" alt="Berry Lace Dress"></a>
                                                </div>
                                                <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                                                <div class="pi-price">$29.00</div>
                ...
                <div class="item carousel-item-five">
                    <div class="container">
                        ...
                        <img class="carousel-position-five animate-delay hidden-sm hidden-xs"
                            src="{{asset('frontend/assets/pages/img/shop-slider/slide2/price.png')}}" alt="Price"
                ...
                <div class="col-md-12 sale-product">
                    ...
                    <div class="owl-carousel owl-carousel5">
                        ...
                        <div>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="{{$p->getPict()}}" class="img-responsive" alt="Berry Lace Dress">
                                    <div>
                                        <a href="{{$p->getPict()}}" class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                                <h3><a href="shop-item.html">{{$p->product_name}}</a></h3>
                                <div class="pi-price">Rp. {{number_format($p->product_price)}}</div>
                                <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                ...
                <div class="col-md-9 col-sm-8">
                    ...
                    <div class="owl-carousel owl-carousel3">
                        <div>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="{{asset('frontend/assets/pages/img/products/k1.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                    <div>
                                        <a href="{{asset('frontend/assets/pages/img/products/k1.jpg')}}"
                        ...
                        <div>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="{{asset('frontend/assets/pages/img/products/k2.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                    <div>
                                        <a href="{{asset('frontend/assets/pages/img/products/k2.jpg')}}"
                                            class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="{{asset('frontend/assets/pages/img/products/k3.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                    <div>
                                        <a href="{{asset('frontend/assets/pages/img/products/k3.jpg')}}"
                                            class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="product-item">
                                <div class="pi-img-wrapper">
                                    <img src="{{asset('frontend/assets/pages/img/products/k4.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                    <div>
                                        <a href="{{asset('frontend/assets/pages/img/products/k4.jpg')}}"
                                            class="btn btn-default fancybox-button">Zoom</a>
                                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                    </div>
                                </div>
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="{{asset('frontend/assets/pages/img/index-sliders/slide1.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                </div>
                                <div class="item">
                                    <img src="{{asset('frontend/assets/pages/img/index-sliders/slide2.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                </div>
                                <div class="item">
                                    <img src="{{asset('frontend/assets/pages/img/index-sliders/slide3.jpg')}}"
                                        class="img-responsive" alt="Berry Lace Dress">
                                </div>
                            </div>
                        </div>
    ...
    <div class="brands">
        <div class="container">
            <div class="owl-carousel owl-carousel6-brands">
                <a href="shop-product-list.html"><img src="{{asset('frontend/assets/pages/img/brands/canon.jpg')}}"
                        alt="canon" title="canon"></a>
                <a href="shop-product-list.html"><img src="{{asset('frontend/assets/pages/img/brands/esprit.jpg')}}"
                        alt="esprit" title="esprit"></a>
                <a href="shop-product-list.html"><img src="{{asset('frontend/assets/pages/img/brands/gap.jpg')}}"
                        alt="gap" title="gap"></a>
                <a href="shop-product-list.html"><img src="{{asset('frontend/assets/pages/img/brands/next.jpg')}}"
                        alt="next" title="next"></a>
                <a href="shop-product-list.html"><img src="{{asset('frontend/assets/pages/img/brands/puma.jpg')}}"
                        alt="puma" title="puma"></a>
                <a href="shop-product-list.html"><img src="{{asset('frontend/assets/pages/img/brands/zara.jpg')}}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><img src="{{asset('frontend/assets/corporate/img/payments/western-union.jpg')}}"
                                alt="We accept Western Union" title="We accept Western Union"></li>
                        <li><img src="{{asset('frontend/assets/corporate/img/payments/american-express.jpg')}}"
                                alt="We accept American Express" title="We accept American Express"></li>
                        <li><img src="{{asset('frontend/assets/corporate/img/payments/MasterCard.jpg')}}"
                                alt="We accept MasterCard" title="We accept MasterCard"></li>
                        <li><img src="{{asset('frontend/assets/corporate/img/payments/PayPal.jpg')}}"
                                alt="We accept PayPal" title="We accept PayPal"></li>
                        <li><img src="{{asset('frontend/assets/corporate/img/payments/visa.jpg')}}" alt="We accept Visa"
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-3">
                    <div class="product-main-image">
                        <img src="{{asset('frontend/assets/pages/img/products/model7.jpg')}}"
                            alt="Cool green dress with red bell" class="img-responsive">
                    </div>
                    <div class="product-other-images">
                        <a href="javascript:;" class="active"><img alt="Berry Lace Dress"
                                src="{{asset('frontend/assets/pages/img/products/model3.jpg')}}"></a>
                        <a href="javascript:;"><img alt="Berry Lace Dress"
                                src="{{asset('frontend/assets/pages/img/products/model4.jpg')}}"></a>
                        <a href="javascript:;"><img alt="Berry Lace Dress"
                                src="{{asset('frontend/assets/pages/img/products/model5.jpg')}}"></a>
                    </div>
                </div>
    ...
    <script src="{{asset('frontend/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js')}}"
        type="text/javascript"></script>
    <!-- END CORE PLUGINS -->

    <!-- BEGIN PAGE LEVEL JAVASCRIPTS (REQUIRED ONLY FOR CURRENT PAGE) -->
    <script src="{{asset('frontend/assets/plugins/fancybox/source/jquery.fancybox.pack.js')}}" type="text/javascript">
    </script><!-- pop up -->
    <script src="{{asset('frontend/assets/plugins/owl.carousel/owl.carousel.min.js')}}" type="text/javascript"></script>
    <!-- slider for products -->
    <script src='{{asset('frontend/assets/plugins/zoom/jquery.zoom.min.js')}}' type="text/javascript"></script>
    <!-- product zoom -->
    <script src="{{asset('frontend/assets/plugins/bootstrap-touchspin/bootstrap.touchspin.js')}}"
