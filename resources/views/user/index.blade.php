...
@section('content')
<div class="carousel relative shadow-2xl bg-white mx-6 my-4">
...
<div class="flex mx-6">
    <div
        class="w-full grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 justify-items-center my-4 mx-2">
    ...
    <div class="card-content px-3">
        <div class="media">
            <div class="media-content">
                ...
                <p class="is-size-6 has-text-weight-semibold mb-2" style="color: #e6632c">
