...
!(function (a) {
    ...
    (function (a) {
        ...
        a.extend(a.fn.editableContainer.Popup.prototype, {
            ...
            innerCss:
                a.fn.popover &&
                a(a.fn.popover.defaults.template).find("p").length
                    ? ".popover-content p"
                    : ".popover-content",
                    ...
                    switch (
                        ...
                        case "bottom":
                            i.top + e >
                                ...
                                (f =
                                    h.top > a(window).scrollTop()
                                        ? "top"
                                        : k.left + d <
                                          a(window).scrollLeft() +
                                              a(window).width()
                                        ? "right"
                                        : j.left > a(window).scrollLeft()
                                        ? "left"
                                        : "right");
                            break;
                        case "top":
                        ...
                        case "left":
                            j.left < a(window).scrollLeft() &&
                                (f =
                                    k.left + d <
                                    a(window).scrollLeft() + a(window).width()
                                        ? "right"
                                        : h.top > a(window).scrollTop()
                                        ? "top"
                                        : h.top > a(window).scrollTop()
    ...
    (function (a) {
        ...
        var b = function (c) {
            this.init("typeahead", c, b.defaults),
                (this.options.typeahead = a.extend(
                    {},
                    b.defaults.typeahead,
                    {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.list),
            a.extend(b.prototype, {
                renderList: function () {
                    ...
                    (b.render = a.proxy(this.typeaheadRender, b)),
                        (b.select = a.proxy(this.typeaheadSelect, b)),
                        (b.move = a.proxy(this.typeaheadMove, b)),
                        this.renderClear(),
                        this.setClass(),
                        this.setAttr("placeholder");
                },
                value2htmlFinal: function (b, c) {
                    if (this.getIsObjects()) {
                        var d = a.fn.editableutils.itemsByValue(
                            b,
                            this.sourceData
                        );
                        b = d.length ? d[0].text : "";
                ...
                value2input: function (b) {
                    if (this.getIsObjects()) {
                        var c = a.fn.editableutils.itemsByValue(
                            b,
                            this.sourceData
                        );
                        this.$input
                            .data("value", b)
                            .val(c.length ? c[0].text : "");
                    } else this.$input.val(b);
                },
                input2value: function () {
                    if (this.getIsObjects()) {
                        var b = this.$input.data("value"),
                            c = a.fn.editableutils.itemsByValue(
                                b,
                                this.sourceData
                            );
                        return c.length &&
                            c[0].text.toLowerCase() ===
                ...
                sorter: function (a) {
                    for (var b, c, d = [], e = [], f = []; (b = a.shift()); )
                        (c = b.text),
                            c.toLowerCase().indexOf(this.query.toLowerCase())
                                ? ~c.indexOf(this.query)
                                    ? e.push(b)
                                    : f.push(b)
                                : d.push(b);
                    return d.concat(e, f);
                ...
                highlighter: function (b) {
                    return a.fn.typeahead.Constructor.prototype.highlighter.call(
                        this,
                        b.text
                    );
                },
                ...
                typeaheadRender: function (b) {
                    ...
                    return (
                        (b = a(b).map(function (b, d) {
                            return (
                                (b = a(c.options.item).data("item", d)),
                                b.find("a").html(c.highlighter(d)),
                                b[0]
                            );
                        })),
                        this.options.autoSelect && b.first().addClass("active"),
                        this.$menu.html(b),
                        this
                    );
                },
